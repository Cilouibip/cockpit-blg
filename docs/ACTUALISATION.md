...
4. migration 021 appliquée (lot U9, inventaire Notion tournant) : `cockpit_migrations` contient 21. Sans elle, les rendez-vous Notion, devenus flux pilote, relieraient l'inventaire complet à chaque demi-heure (9 appels du tick par passage).
