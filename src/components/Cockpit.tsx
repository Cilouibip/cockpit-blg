...
function Results({ data, compare, onMetric, onConnections, filters }: { data: DashboardResponse; filters: DashboardFilters; compare: boolean; onMetric: (metric: Metric) => void; onConnections: () => void }) {
