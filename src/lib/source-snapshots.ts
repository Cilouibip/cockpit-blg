...
export function invalidateSourceWindow(db:Database,source:string,namespace:string,window:SourceWindow){cache.get(db)?.delete(JSON.stringify(snapshotArgs(source,namespace,window)));}
