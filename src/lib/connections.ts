...
export async function connections():Promise<ConnectionsResponse> {
  ...
  return {mode:config.mode,connections:[
    ...
    connection('wix','Wix · encaissements',!!process.env.WIX_API_KEY,['CA issu de la synthèse des paiements Wix, actualisé pour la période choisie.','Attribution et LTV attendent le rapprochement des paiements par client.'],true),
