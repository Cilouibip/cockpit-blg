...
Application de suivi descriptif de l'acquisition et de la conversion : liens de campagne, parcours quiz et masterclass, rendez-vous et encaissements.

La conception fonctionnelle est validée. Le modèle de données proposé doit recevoir sa relecture technique avant la première migration. Aucun jeu de données client ni secret n'appartient à ce dépôt public.
